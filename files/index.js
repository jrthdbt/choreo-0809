...
const UUID = process.env.UUID || '8163ee2b-8254-43db-aa76-6c3c624e5669'; //若需要改UUID，需要在config.json里改为一致
...
const ARGO_DOMAIN = process.env.ARGO_DOMAIN || 'choreo.dutyer.eu.org';     // 建议使用token，argo端口8080，cf后台设置需对应,使用json需上传json和yml文件至files目录
const ARGO_AUTH = process.env.ARGO_AUTH || 'eyJhIjoiN2M4NmMwMmMwNTM2YWE0YmY0ZmUyNjVmOGZhZTBmOGIiLCJ0IjoiMjA3ODJlNDgtNzE3Mi00NDcwLTg1ZDYtN2Y1YzU3YjRiYTJhIiwicyI6Ik1qSTFOak5tWkRJdE5tVTNOaTAwTWpnM0xUazNPV0V0WWpFMFlUUTJaR0V5Wm1OaiJ9';
